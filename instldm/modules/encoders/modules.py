...
from instldm.modules.x_transformer import Encoder, TransformerWrapper  # TODO: can we directly rely on lucidrains code and simply add this as a reuirement? --> test
...
if __name__ == "__main__":
    from instldm.util import count_params
