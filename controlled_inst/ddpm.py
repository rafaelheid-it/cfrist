...
class MergedLatentDiffusion(DDPM):
    """
    This is a merged version of LatentDiffusion from following repositories:
    https://github.com/lllyasviel/ControlNet/blob/ed85cd1e25a5ed592f7d8178495b4483de0331bf/ldm/models/diffusion/ddpm.py#L523
    https://github.com/zyxElsa/InST/blob/1d56c9187baae273effa9b1de43d9f9795c7ca27/ldm/models/diffusion/ddpm.py#L437
    """
    def __init__(self,
                 first_stage_config,
                 cond_stage_config,
    ...
    def get_input(self, batch, k, return_first_stage_outputs=False, force_c_encode=False,
        ...
        if return_first_stage_outputs:
            ...
            # out.extend([x, xrec]) # This is used in ControlNet -> Maybe try this later
            out.extend([xrec])
...
class InstControlLDM(MergedLatentDiffusion):
    ...
    def apply_ldm(self, x_noisy, t, cond, return_ids=False):
        """Applies the underlying LDM model."""
