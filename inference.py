...
model.embedding_manager.load(f"./logs/{log_dir}/checkpoints/embeddings_gs-599.pt")
model = model.to(device)

content_image = "Images/axe_reference_3.jpg"
style_image = "/data2/4heid/humblebundle/axes/1.png"
    ...
    for scale in scales:
        for strength in strengths:
            ...
            main(prompt = '*', \
                content_dir = c_image, \
                style_dir = s_image, \
                outdir_name = "test_subtracted_clip_embeddings_599/" + log_dir, \
                ddim_steps = 50, \
                strength = strength, \
                seed=23, \
                model = model, \
